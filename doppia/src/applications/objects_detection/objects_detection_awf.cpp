...
int main(int argc, char *argv[])
{
    ...
    string awf_root = "/home/wln/face/AFW";
    string awf_lable = awf_root + "/awf_lable.txt";
    string awf_imgs = awf_root + "/testimages/";
    //sprintf(awf_lable,"%s/awf_lable.txt",awf_root);
    try
    {
		...
		if(ok){
            ...
            ifstream f;
            cout<<awf_lable<<endl;
            f.open(awf_lable.c_str(),fstream::in);
            if(!f){
